...
func _init_first_person_mode():
	...
	cam_holder._initialize_player_camera()
...
func _on_countdown_timer_countdown_started(_initial_value: int) -> void:
	_init_first_person_mode()
